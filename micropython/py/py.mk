...
# ALL_LVGL_SRC = $(shell find $(LVGL_DIR) -type f) $(TOP)/../esp/esp-idf/components/lv_conf.h
...
# 	$(Q)$(PYTHON) $(LVGL_BINDING_DIR)/gen/gen_mpy.py -M lvgl -MP lv -MD $(LVGL_MPY_METADATA) -I../lib/berkeley-db-1.xx/PORT/include -I$(LVGL_BINDING_DIR) -I. -I../.. -Ibuild -I../../mp-readline -I $(LVGL_BINDING_DIR)/pycparser/utils/fake_libc_include $(LVGL_DIR)/lvgl.h > $@
